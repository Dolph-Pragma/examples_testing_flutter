...
import 'package:githubuser_withtest/utils/constants.dart';
import 'package:githubuser_withtest/utils/validate_user_data.dart';
...
void main() {
  group('Testing isValidUserValue', () {
    ...
    test('should return true becaues is valid value', () {
      ...
      //Act
      final isCurrentHeightValid =
          isValidateUserValue(fakeValidValue, minValue, maxValue);
      //assert
